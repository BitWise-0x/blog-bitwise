...
If you have made it this far, congratulations - you now have a good understanding of the most popular decentralized finance (DeFi) protocol by market capitalisation, one that has powered 55M trades and nearly $295B by market volume. The rest of the article covers other protocols that have innovated on Uniswap.
...
> [!NOTE]
> Since this article was originally written, the AMM space has continued to evolve significantly. Uniswap v3 introduced concentrated liquidity, allowing LPs to allocate capital within specific price ranges for improved capital efficiency. Uniswap v4 introduces "hooks" that allow developers to customise pool behaviour with arbitrary logic. These innovations deserve a dedicated follow-up.
